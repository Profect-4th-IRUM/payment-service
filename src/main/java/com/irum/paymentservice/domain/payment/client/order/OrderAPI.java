...
import com.irum.paymentservice.domain.payment.client.order.dto.request.UpdateOrderStatusRequest;
...
public interface OrderAPI {
    ...
    @PatchMapping("failed")
    void updateOrderStatusFailed(@RequestBody UpdateOrderStatusFailedRequest updateOrderStatusFailed);
